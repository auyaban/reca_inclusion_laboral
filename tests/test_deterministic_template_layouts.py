...
class DeterministicTemplateLayoutTests(unittest.TestCase):
    ...
    def test_condiciones_vacante_template_rows(self) -> None:
        ...
        self.assertRowStartsWith(ws, 158, "7. OBSERVACIONES / RECOMENDACIONES")
        self.assertRowStartsWith(ws, 160, "8.ASISTENTES")
        self.assertEqual(condiciones._section_7_content_row_for_payload([{}] * 4), 156)
        self.assertEqual(condiciones._section_7_content_row_for_payload([{}] * 8), 160)
        self.assertEqual(condiciones._section_8_start_row_for_payload([{}] * 4), 158)
        self.assertEqual(condiciones._section_8_start_row_for_payload([{}] * 8), 162)
